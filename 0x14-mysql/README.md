...
In this project, we see how we configure database servers in a primary-replica model. We configured the two servers provided to us by
ALX in a MySQL primary-replica setup with a dummy database, and wrote a Bash script to automate generation of database backups.
